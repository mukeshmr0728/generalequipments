...
const socialLinks = [
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/company/generalequipments',
    icon: (
  ...
  {
    name: 'X (Twitter)',
    href: 'https://twitter.com/genequipments',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Instagram',
    href: 'https://instagram.com/generalequipments',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            <Link to="/" className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-steel-600 flex items-center justify-center">
                <Cog className="w-6 h-6 text-white" />
              </div>
              <span className="font-bold text-xl tracking-tight">General Equipments</span>
            </Link>
            <p className="text-charcoal-400 text-sm leading-relaxed mb-6">
              Industrial excellence through engineered solutions. Your trusted partner for
          ...
          <div>
            <h3 className="font-semibold text-sm uppercase tracking-wider mb-6">Contact</h3>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-steel-500 flex-shrink-0 mt-0.5" />
              ...
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-steel-500 flex-shrink-0" />
                <a href="tel:+15551234567" className="text-charcoal-400 hover:text-white text-sm transition-colors">
                  +1 (555) 123-4567
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-steel-500 flex-shrink-0" />
                <a href="mailto:info@generalequipments.com" className="text-charcoal-400 hover:text-white text-sm transition-colors">
        ...
        <div className="container-wide py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-charcoal-500 text-sm">
              {new Date().getFullYear()} General Equipments. All rights reserved.
            </p>
            <div className="flex items-center gap-6">
              {legalLinks.map((link) => (
                <Link
                  key={link.name}
                  to={link.href}
                  className="text-charcoal-500 hover:text-white text-sm transition-colors"
                >
                  {link.name}
                </Link>
              ))}
